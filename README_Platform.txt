...
3. You should add module name to 'PRODUCT_PACKAGES' in 'build\target\product\core.mk' as following case.
	...
	case 5) KeyUtils : should add 'webkit' to PRODUCT_PACKAGES
	case 6) KeyUtils : should add 'gcc-denangle' to PRODUCT_PACKAGES
	case 7) KeyUtils : should add 'junit' to PRODUCT_PACKAGES
