...
//SAMSUNG CHANGES >>
void RenderLayer::removeCorruptedLayerLists(Vector<RenderLayer*>* list)
{
	if(list)
	{
...
{
   removeCorruptedLayerLists(m_posZOrderList); //SAMSUNG CHANGES
   removeCorruptedLayerLists(m_negZOrderList); //SAMSUNG CHANGES
...
void RenderLayer::updateNormalFlowList()
{
    ...
    removeCorruptedLayerLists(m_normalFlowList); //SAMSUNG CHANGES
