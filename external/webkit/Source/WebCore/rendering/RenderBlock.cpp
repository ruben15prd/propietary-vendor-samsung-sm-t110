...
void RenderBlock::styleDidChange(StyleDifference diff, const RenderStyle* oldStyle)
{
    ...
    //WAS bool canPropagateFloatIntoSibling = !isFloatingOrPositioned() && !avoidsFloats();
	bool avoidFloats = RenderBox::avoidsFloats() || (style() ?(!style()->hasAutoColumnCount()):true) || ( style() ?(!style()->hasAutoColumnWidth()):true);
    bool canPropagateFloatIntoSibling = !isFloatingOrPositioned() && !avoidFloats;
