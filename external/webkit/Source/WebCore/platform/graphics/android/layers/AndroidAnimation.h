...
// 4.2 Merge BEGIN <<
    ...
    void setName(const String& name) { m_name = name.threadsafeCopy(); } //name.threadsafeCopy()
    bool isNamed(const String& name) { return m_name == name; }
    String nameCopy() { return m_name.threadsafeCopy(); } //returning name.threadsafeCopy()
// 4.2 Merge END >>
