...
public:
    ...
    const char* subclassName() const//4.2 Merge
    {
        switch (subclassType()) {
...
// 4.2 Merge END >>
    ...
    */
    ...
    float maxZoomScale() const;//4.2  bool hasText(); replaced with this function
...
//    void copyAnimationStartTimes(LayerAndroid* oldLayer);//4.2 Merge : removed in 4.2
//    bool prepareContext(bool force = false);//4.2 Merge : removed in 4.2
