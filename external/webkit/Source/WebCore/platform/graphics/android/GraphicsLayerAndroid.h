...
#include "PicturePile.h"//4.2 Merge
#include "RefPtr.h"
...
class GraphicsLayerAndroid : public GraphicsLayer, PicturePainter {//4.2 Merge
public:
...
private:
    ...
    bool paintContext(LayerAndroid* layer, PicturePile& picture);//4.2 Merge
