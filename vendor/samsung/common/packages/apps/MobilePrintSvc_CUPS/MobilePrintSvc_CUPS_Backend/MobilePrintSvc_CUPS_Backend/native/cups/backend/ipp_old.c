...
int					/* O - Exit status */
ipp_main(int  argc,				/* I - Number of command-line args */
...
LOGI("ipp: auth_info = %s", auth_info_required);
...
LOGI("ipp: final_content_type = %s", final_content_type);
    ...
    _cups_monitor_t *monitor)		/* I - Monitoring data */
{
  ...
  int		delay,			/* Current delay */
   ...
   //copy monitor to aviod SIGSEGV
 // _cups_monitor_t monitor_loc, *monitor;
   
 //  monitor_loc.uri           = monitor_parent->uri;
 //  monitor_loc.hostname      = monitor_parent->hostname;
 //  monitor_loc.user          = monitor_parent->user;
 //  monitor_loc.resource      = monitor_parent->resource;
 //  monitor_loc.port          = monitor_parent->port;
 //  monitor_loc.version       = monitor_parent->version;
 //  monitor_loc.job_id        = monitor_parent->job_id;
 //  monitor_loc.encryption    = monitor_parent->encryption;
 //  monitor_loc.job_state     = monitor_parent->job_state;
 //  monitor_loc.printer_state = monitor_parent->printer_state;
 //  monitor = &monitor_loc;
   //copy monitor end
