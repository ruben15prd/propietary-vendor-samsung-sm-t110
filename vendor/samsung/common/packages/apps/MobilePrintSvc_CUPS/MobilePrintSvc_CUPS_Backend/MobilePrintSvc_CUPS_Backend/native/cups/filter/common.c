    ...
    int           change_size)		/* I - Change page size? */
{
  ...
  LOGI("filter/common.c/SetCommonOptions()/ppdFilePath=%s",ppdFilePath);
  ...
  if ((pagesize = ppdPageSize(ppd, NULL)) != NULL)
  {
    ...
    LOGI("filter/common.c/SetCommonOptions()/PageWidth=%f, PageLength=%f, PageLeft=%f, PageBottom=%f, PageRight=%f, PageTop=%f",PageWidth, PageLength, PageLeft, PageBottom, PageRight, PageTop);
