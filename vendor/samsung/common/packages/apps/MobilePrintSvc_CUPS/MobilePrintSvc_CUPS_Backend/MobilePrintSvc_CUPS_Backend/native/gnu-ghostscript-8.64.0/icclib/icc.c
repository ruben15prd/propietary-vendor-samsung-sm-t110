...
size_t count
	...
	//LOGI("icclib/icc.c/icmFileStd_read");
	icmFileStd *p = (icmFileStd *)pp;
...
size_t count
	...
	//LOGI("icclib/icc.c/icmFileStd_write");
	icmFileStd *p = (icmFileStd *)pp;
...
icmFile *pp
	...
	//LOGI("icclib/icc.c/icmFileStd_flush");
	icmFileStd *p = (icmFileStd *)pp;
...
icmFile *pp
	...
	//LOGI("icclib/icc.c/icmFileStd_delete");
	icmFileStd *p = (icmFileStd *)pp;
...
FILE *fp
	...
	//LOGI("icclib/icc.c/new_icmFileStd_fp");
	icmFileStd *p;
...
char *mode
	...
	//LOGI("icclib/icc.c/new_icmFileStd_name : name=%s",name);
	//LOGI("icclib/icc.c/new_icmFileStd_name : mode=%s",mode);
...
long int offset
	...
	//LOGI("icclib/icc.c/icmFileMem_seek");
...
size_t count
	...
	//LOGI("icclib/icc.c/icmFileMem_read");
	icmFileMem *p = (icmFileMem *)pp;
	size_t len;
...
size_t count
	...
	//LOGI("icclib/icc.c/icmFileMem_write");
	icmFileMem *p = (icmFileMem *)pp;
	size_t len;
...
icmFile *pp
	...
	//LOGI("icclib/icc.c/icmFileMem_delete");
	icmFileMem *p = (icmFileMem *)pp;
...
size_t length			/* Number of bytes in buffer */
	...
	//LOGI("icclib/icc.c/new_icmFileMem");
	icmFileMem *p;
...
size_t size
	...
	//LOGI("icclib/icc.c/icmAllocStd_malloc");
	return malloc(size);
}
...
size_t size
	...
	//LOGI("icclib/icc.c/icmAllocStd_calloc");
...
size_t size
	...
	//LOGI("icclib/icc.c/icmAllocStd_realloc");
...
void *ptr
	...
	//LOGI("icclib/icc.c/icmAllocStd_free");
	free(ptr);
}
...
icmAlloc *pp
	...
	//LOGI("icclib/icc.c/icmAllocStd_delete");
...
icmAlloc *new_icmAllocStd() {
	//LOGI("icclib/icc.c/new_icmAllocStd");
	icmAllocStd *p;
	...
	//LOGI("icclib/icc.c/new_icmAllocStd : allocated memory");
	return (icmAlloc *)p;
}
...
static icmLuBase* icc_get_luobj (
	...
	//LOGI("icclib/icc.c/icc_get_luobj");
	int rv;
...
icmAlloc *al			/* Optional memory allocator. NULL for default */
	...
	icc *p;
	int del_al = 0;
	//LOGI("icclib/icc.c/new_icc_a");
	if (al == NULL) {	/* None provided, create default */
		//LOGI("icclib/icc.c/new_icc_a : al == null");
