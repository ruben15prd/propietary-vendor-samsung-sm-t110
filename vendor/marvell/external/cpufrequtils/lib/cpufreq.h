...
/* joint two policies together
 *
 * Choose the intersection freq set of two policies and the more aggressive
 * governor prior to the conservative one from the aspect of performance.
 */
extern int cpufreq_joint_policy(struct cpufreq_policy *joint,
